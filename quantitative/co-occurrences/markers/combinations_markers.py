...
with open('curated_onlymodal.csv') as file:
...
with open('combinations_onlymodal.csv', 'w') as f:
    write = csv.writer(f)
...
df = pd.read_csv('combinations_onlymodal.csv', names=['m1', 'm2'])
# print(df)
...
m.to_csv('basematrix_onlymodal.csv', index=True)
